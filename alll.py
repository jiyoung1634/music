...
MELODY = [
    ('D', 0.25), ('B', 0.25), ('A', 0.25), ('G', 0.25), ('D', 0.5),
    ('D', 0.25), ('B', 0.25), ('A', 0.25), ('G', 0.25), ('E', 0.5),
    ('E', 0.25), ('C5', 0.25), ('B', 0.25), ('A', 0.25), ('F', 0.5),
    ('D5', 0.25), ('D5', 0.25), ('C5', 0.25), ('A', 0.25), ('B', 0.5), ('G', 0.5),
    ('D', 0.25), ('B', 0.25), ('A', 0.25), ('G', 0.25), ('D', 0.5),
    ('D', 0.25), ('B', 0.25), ('A', 0.25), ('G',0.25), ('E', 0.5),
    ('E', 0.25), ('C5', 0.25), ('B', 0.25), ('A', 0.25), ('D5', 0.7), ('D5', 0.7), ('D5', 0.25), ('D5', 0.25),
    ('E5', 0.25), ('D5', 0.25), ('C5', 0.25), ('A', 0.25), ('G', 0.5), ('B', 0.5),
...
def play_tone(pin, frequency, duration):
    ...
    while time.time() < end_time:
        ...
        time.sleep(half_period)
    # 음과 음 사이에 약간의 간격을 추가
    time.sleep(0.03)  # 10ms의 지연시간 추가 (필요에 따라 조절)
